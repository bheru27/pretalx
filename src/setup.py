...
setup(
    ...
    install_requires=[
        ...
        "django-bootstrap4>=2.0,<2.3",  # http://django-bootstrap4.readthedocs.io/en/latest/history.html
        ...
        "django-csp~=3.6.0",  # https://github.com/mozilla/django-csp/blob/master/CHANGES
